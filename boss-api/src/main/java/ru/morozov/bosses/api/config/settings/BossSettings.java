package ru.morozov.bosses.api.config.settings;
...
import ru.morozov.bosses.api.config.settings.time.BossTimeSettings;
import ru.morozov.bosses.api.utils.builder.ItemBuilder;
